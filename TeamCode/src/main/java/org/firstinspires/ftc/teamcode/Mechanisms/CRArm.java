...
public class CRArm {
    ...
    public static double leftZeroVoltage = 3.252;
    public static double rightZeroVoltage = 0.299;
    ...
    public void updateEncoders() {
        if (useVoltageCompensation) {
            leftEncoder.update(leftServo.getPower(), true);
            rightEncoder.update(rightServo.getPower(), false);
            return;
        }
    ...
    public static double setAngleTimeout = 2;
