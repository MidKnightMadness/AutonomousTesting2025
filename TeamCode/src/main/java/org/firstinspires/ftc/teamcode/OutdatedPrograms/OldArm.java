...
public class OldArm {
    ...
    double lastSetPosition = OldArm.INIT_AUTO_POS;
    Timer timer;
    ...
    public void setInitPosition() {
        lastSetPosition = OldArm.INIT_AUTO_POS;
        leftServo.setPosition(OldArm.INIT_AUTO_POS);
        rightServo.setPosition(OldArm.INIT_AUTO_POS);
    }
